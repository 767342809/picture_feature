...
def _get_outputs_from_inputs(input_tensors, model):
    ...
    output_tensors = model.predict(inputs)
    postprocessed_tensors = model.postprocess(output_tensors)
    return _add_output_tensor_nodes(postprocessed_tensors)


def _build_model_graph(input_type, model, input_shape, graph_hook_fn):
...
if __name__ == "__main__":
    export_inference_graph("image_tensor", Model(158, False), './training/model.ckpt-2000', "./outfilel3_0.1_2000", input_shape=[None, 224, 224, 3])